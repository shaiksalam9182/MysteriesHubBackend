exports.dis_like_place = (req, res) => {
        ...
        if (decoded.user_id == req.body.user_id) {
            ...
            postmodel.find({
                ...
                if (Object.keys(data).length == 0) {
                    ...
                    postmodel.update({ place_id: req.body.place_id }, { $push: { dis_likes: req.body.email } })
                        .then(data => {
                            // res.json(data);
                            postmodel.find({
                                place_id: req.body.place_id
                    ...
                    postmodel.update({ place_id: req.body.place_id }, {
                        ...
                        postmodel.find({ place_id: req.body.place_id }, { _id: 0, dis_likes: 1 }).then(data => {
                            ...
                            postmodel.update({
                                ...
                                if (Object.keys(data).length == 0) {
                                    ...
                                    postmodel.find({ place_id: req.body.place_id }, { _id: 0, place_id: 1, dis_likes_count: 1 }).then(data => {
                                        var finaldata = data[0].toObject();
                                        finaldata.delete = 1;
                                        finaldata.status = 'success';
                                        res.json(finaldata);
