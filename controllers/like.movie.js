        ...
        if (decoded.android_id == req.body.android_id) {
            ...
            postmodel.find({
                ...
                if (Object.keys(data).length == 0) {
                    ...
                    postmodel.update({ movie_id: req.body.movie_id }, { $push: { likes: req.body.phone } })
                        .then(data => {
                            // res.json(data);
                            postmodel.find({
                                movie_id: req.body.movie_id
                    ...
                    postmodel.update({ movie_id: req.body.movie_id }, {
                        ...
                        postmodel.find({ movie_id: req.body.movie_id }, { _id: 0, likes: 1 }).then(data => {
                            ...
                            postmodel.update({
                                ...
                                if (Object.keys(data).length == 0) {
                                    ...
                                    postmodel.find({ movie_id: req.body.movie_id }, { _id: 0, movie_id: 1, likes_count: 1 }).then(data => {
                                        var finaldata = data[0].toObject();
                                        finaldata.delete = 1;
                                        finaldata.status = 'success';
                                        res.json(finaldata);
