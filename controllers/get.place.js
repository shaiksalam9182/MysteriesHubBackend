exports.get_place = (req, res) => {
    console.log(req.query.id);
    // console.log(req.useragent);
    if (req.useragent.isAndroid) {
        res.redirect('intent://URLHandler/#Intent;scheme=naradh;package=com.salam.naradh;S.payload=type%3Dplaces%26%26id%3D' + req.query.id + ';end')
    } else {
